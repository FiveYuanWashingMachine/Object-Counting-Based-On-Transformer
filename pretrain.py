...
import model.models_2 as models_2
...
def get_args_parser():
    ...
    parser.add_argument('--resume', default=None,  # mae_visualize_vit_base
...
def main(args):
    ...
    # define the model
    model = models_2.__dict__[args.model](norm_pix_loss=args.norm_pix_loss)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        model_ = getattr(models_2, args.model)()
