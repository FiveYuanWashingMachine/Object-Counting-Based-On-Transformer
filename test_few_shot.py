...
def get_args_parser():
    ...
    parser.add_argument('--resume', default='./data/out/fim6_dir/checkpoint__finetuning_minMAE.pth',
...
def main(args):
    ...
    for data_iter_step, (samples, gt_dots, boxes, pos, gt_map, im_name) in \
        ...
        if args.normalization:
            ...
            # if e_cnt < 2:
            #     e_cnt_new = e_cnt*e_cnt-2*e_cnt+2
            # else:
            #     e_cnt_new = e_cnt
            # if e_cnt <= 1:
            #     e_cnt_new = 1
        ...
        cnt_err_new = cnt_err/gt_cnt
        train_mae += cnt_err
        train_rmse += cnt_err ** 2
        train_mae_new += cnt_err_new
        train_rmse_new += cnt_err_new ** 2
    ...
    print('Current MRE: {:5.6f}, RMRSE: {:5.6f} '.format(train_mae_new / (len(data_loader_test)), (
                train_rmse_new / (len(data_loader_test))) ** 0.5))
